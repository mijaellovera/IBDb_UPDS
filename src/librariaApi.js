...
function desdeBD(row, i) {
  return {
    ...
    year: row.anio,
    img: row.portada_url || PLACEHOLDER,
    isbn: row.isbn_13,
...
export async function obtenerLibros({ buscar = '', orden = 'default', pagina = 1, porPagina = 12 } = {}) {
  const params = new URLSearchParams({ buscar, orden, pagina, porPagina })
